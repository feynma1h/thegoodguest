...
is the working list; `PROJECT.md` stays the statement of what is true now, and
...
work — it is documents quietly going out of date. On 2026-08-26 PROJECT.md
...
red five days while PROJECT.md recorded it green.
...
None of these blocks shipping. All are measured, and all shape how good the
product looks when it ships. **Read `PROJECT.md`'s measured-dead-ends section
