...
carries a 7-day TTL"*), and in PROJECT.md's retention line.
...
docstring, and PROJECT.md's retention line. **For the labels: do not state 7 days
anywhere.**
...
amendment when APNs ships (PROJECT.md records push as stubbed at named seams
...
### F7 — PROJECT.md is stale on the material confidence gate

PROJECT.md's open-defects list says *"Recommended and NOT applied: raise
