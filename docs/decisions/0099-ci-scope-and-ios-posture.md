...
every single run. That is a deliberate posture — PROJECT.md's iOS test policy
...
backend outage — the trap PROJECT.md already documents for fresh worktrees), and
