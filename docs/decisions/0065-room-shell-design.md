...
walls or floor — rooms are furniture on a grid. PROJECT.md has carried
...
- **Per-capture scene-3DGS training** (the literal reading of PROJECT.md's
  ...
  again. The phrase "inpainted scene-3DGS" in PROJECT.md is superseded by this
  note.
