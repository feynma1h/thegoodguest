...
wants a DAG; PROJECT.md files version history as direction, not commitment), the
...
PROJECT.md files this under *budget-aware shopping*, in the direction-not-
...
change than it looks, and it is why PROJECT.md files it separately.
