...
The web app (Next.js + WebGPU splat rendering, per PROJECT.md's "What we're building") had
never actually had its hosting or framework choice examined — "Next.js" appeared in PROJECT.md's
