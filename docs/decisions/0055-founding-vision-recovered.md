...
PROJECT.md had drifted into pure infrastructure framing — "browse, edit, replace, share
...
**Durable (now written into PROJECT.md as the product frame):**
...
header pointing here; PROJECT.md's "What we're building" rewritten to lead with the
...
- Product-direction changes belong in PROJECT.md's vision section + a note superseding
