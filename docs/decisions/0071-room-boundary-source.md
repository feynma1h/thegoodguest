...
**Date:** 2026-07-24
**Status:** Superseded by 0077 — Option A (Pro-only / LiDAR-first, RoomPlan as the room source) was taken, and 0077 is its design. The measured facts below stand.

The operator settled the fork after the co-run spike
