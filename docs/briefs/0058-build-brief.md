...
here so the brief survives the sessions that carried it. Consumer: the session that implements conversation stage 1 — hand it over with one adjustment: the docs half is ALREADY DONE
(decision 0058 and its PROJECT.md delta landed on main in commit 5c9dad7), so
...
Convention:  See PROJECT.md and decision 0058 (paste-delivered with this brief —
             ...
             housekeeping per PROJECT.md; the PROJECT.md delta accompanying this
