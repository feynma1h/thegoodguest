...
Consumer: whichever session runs 6(a) — hand the brief body over as the
...
0051 enrollment runbook bullet in PROJECT.md).

Delete this file when 6(a) ships — PROJECT.md becomes the durable record.
-->
...
Convention:  See PROJECT.md. Housekeeping closes the stale "0051 remains
