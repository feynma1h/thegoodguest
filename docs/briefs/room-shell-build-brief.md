...
half is ALREADY DONE (decision 0066 and the CLAUDE.md delta land with the
...
```
Read CLAUDE.md and .claude/WORKFLOW.md first. Decision 0066 is the design
...
Convention:  See CLAUDE.md and decision 0066. Tests pin invariants, not
