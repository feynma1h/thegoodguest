...
half is ALREADY DONE (decision 0065 and the PROJECT.md delta land with the
...
```
Read PROJECT.md first. Decision 0065 is the design
...
Convention:  See PROJECT.md and decision 0065. Tests pin invariants, not
