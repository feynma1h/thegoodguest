...
Consumer: the session(s) that build it — chunks A–C are separable and
...
capture. Hand over with one adjustment: the
docs half is ALREADY DONE (decision 0067 and the PROJECT.md delta land with
...
```
Read PROJECT.md first. Decision 0067 is the design
...
Convention:  See PROJECT.md and decision 0067. Tests pin invariants at
             ...
             build) — rebase, hand-merge PROJECT.md bullets, renumber a
