...
**Status:** SERVING as of 2026-08-09/10 — the four-surface deploy (`api-public-00034-zad`, hosting 23:31:04, `api-internal-00023-mek`, `perception-obj-00038-7b5`). Deploy findings in decisions 0106–0109. Remaining: the operator's two-minute production browser check (CLAUDE.md's P0 bullet).
