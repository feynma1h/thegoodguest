...
from the working tree and then purged from git history before the repo gained
a remote (decision 0101). Neither the blobs nor the commits that touched them
survive: `git rev-list --objects --all | grep -c HEIC` returns 0.
