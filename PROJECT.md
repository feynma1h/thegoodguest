...
command. The last figures WITH the fixtures staged are `main`'s **884 + 27**
and **902 + 27** (2026-08-25); the fixture-backed set skips silently, so the
lower number from a worktree is correct rather than regressed. re-enqueue **18**.
