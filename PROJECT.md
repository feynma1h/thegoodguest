...
Suite **620**: 614 asserting offline tests + 2 boilerplate stubs + 4 live
...
**Honest count:** report as "614 asserting offline unit tests + 2 boilerplate stubs (`testExample`/`testPerformanceExample`) + 4 live integration tests (require a reachable backend)", total 620 — not a bare total: the 2 stubs assert nothing and the 4 integration tests carry an external dependency the unit tests don't.
