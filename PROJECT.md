...
**Decision numbers.** **Always derive the free list from `ls docs/decisions/`, not from this paragraph** — it has lagged three times. As of 2026-08-19, with all three parallel lanes merged and nothing reserved: **free are 0113, 0121, 0128, 0134, 0144, 0145, 0167, 0168, 0186, 0189, 0192, 0193, 0194, 0195, 0196, 0200+ (0197–0199 reserved to the clipped-views lane; the disk-cleanup lane released 0195–0196 unused)**. Spent by those lanes: **0165/0166** (lane D's deficit decomposition and its union negative), **0184/0185** (the guest's colours and names), **0188** (the renderer key's split). Released unused: **0167–0168** and **0186** and **0189**, each reserved to a lane that did not need its whole block, and **0192–0194** — de-occlusion's gate was measured and did not clear (0165), so that lane is closed rather than pending. Everything else through 0194 is used.
