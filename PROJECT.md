...
tools/                            local scripts (run from repo root)
  gen_proto.sh                      regenerate Python and Swift (ios/TheGoodGuestCapture/TheGoodGuestCapture/Generated/)
...
### iOS capture app — `ios/TheGoodGuestCapture/`
