...
Suites: schemas **120**, root **787 passed + 102 skipped** WITHOUT
`web/public/dev-fixtures` (2026-08-21). The fixtures-staged figure has not
been re-measured since 0213/0214 added 23 tests; it was 839 + 26 before them
— always say which. re-enqueue **18**.
