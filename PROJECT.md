...
2. **Wire perception dispatch** — after validation passes, `POST /ingest` triggers `perception-obj`/`perception-geom`. Before building: a design session on sync vs. async dispatch.
