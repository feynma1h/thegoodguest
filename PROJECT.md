...
**Decision numbers.** **Always derive the free list from `ls docs/decisions/`, not from this paragraph** — it has lagged three times. As of 2026-08-20, with the clipped-views lane merged and **nothing reserved**: **free are 0113, 0121, 0128, 0134, 0144, 0145, 0167, 0168, 0186, 0189, 0192, 0193, 0194, 0195, 0196, 0199, 0200+**. Spent by clipped-views: **0197** (the uncropped photograph is not a better photograph) and **0198** (the mask is the photograph SAM 3D sees); **0199** was reserved to that lane and released unused, as were **0195–0196** by disk-cleanup. Everything else through 0198 is used.
