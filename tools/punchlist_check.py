...
documents going quietly out of date. On 2026-08-26 PROJECT.md asserted CI was
...
def check_web_base_url():
    ...
    src = _read("ios/RoomStudioCapture/RoomStudioCapture/Networking/NetworkConfig.swift")
