/// The Xcode-generated anchor class for the TheGoodGuestCaptureTests target.
///
...
/// PROJECT.md's iOS test policy). The suites that pin behaviour live in sibling
...
final class TheGoodGuestCaptureTests: XCTestCase {
