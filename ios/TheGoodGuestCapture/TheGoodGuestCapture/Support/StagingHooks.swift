...
/// (pre-send sabotage), TheGoodGuestCaptureApp + AppDelegate (breadcrumbs).
...
nonisolated enum StagingHooks {
    ...
    private static var breadcrumbFileURL: URL {
        ...
        let dir = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
            .appendingPathComponent(Bundle.main.bundleIdentifier ?? "com.thegoodguest.TheGoodGuestCapture")
    ...
    private static let logger = Logger(subsystem: "com.thegoodguest.TheGoodGuestCapture", category: "Staging")
