/// UIApplicationDelegate for TheGoodGuest Capture.
///
...
///
/// Wired via @UIApplicationDelegateAdaptor in TheGoodGuestCaptureApp.
///
...
final class AppDelegate: NSObject, UIApplicationDelegate {
    ...
    private let logger = Logger(subsystem: "com.thegoodguest.TheGoodGuestCapture", category: "AppDelegate")
