...
actor BlobUploadManager {
    ...
    static let backgroundSessionIdentifier = "com.thegoodguest.capture.blobUpload"
    ...
    private let logger = Logger(subsystem: "com.thegoodguest.TheGoodGuestCapture", category: "BlobUpload")
    ...
    ///
    /// Called at launch via a .task modifier in TheGoodGuestCaptureApp. Loads all persisted
