...
final class CaptureManager: NSObject, ObservableObject {
    ...
    private let jpegQueue   = DispatchQueue(label: "com.thegoodguest.capture.jpeg", qos: .utility)
    ...
    private let logger = Logger(subsystem: "com.thegoodguest.TheGoodGuestCapture", category: "Capture")
