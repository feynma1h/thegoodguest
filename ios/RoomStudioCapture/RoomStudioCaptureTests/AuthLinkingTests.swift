...
///     (RoomStudioCapture-Info.plist) and the GITIGNORED client ID
...
final class AuthLinkingTests: XCTestCase {
    ...
    /// (RoomStudioCapture-Info.plist) while the client ID it derives from is
    ...
    func test_appBundle_registersRedirectSchemeForLiveClientID() throws {
        ...
        XCTAssertTrue(
            ...
            RoomStudioCapture-Info.plist to match the plist's \
