...
/// (pre-send sabotage), RoomStudioCaptureApp + AppDelegate (breadcrumbs).
...
nonisolated enum StagingHooks {
    ...
    private static var breadcrumbFileURL: URL {
        ...
        let dir = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
            .appendingPathComponent(Bundle.main.bundleIdentifier ?? "com.roomstudio.RoomStudioCapture")
    ...
    private static let ioQueue = DispatchQueue(label: "com.roomstudio.staging.io", qos: .utility)

    private static let logger = Logger(subsystem: "com.roomstudio.RoomStudioCapture", category: "Staging")
