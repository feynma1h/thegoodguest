...
struct TheGoodGuestApp: App {
    ...
    init() {
        ...
        //   File > Add Files > GoogleService-Info.plist, target: TheGoodGuest.
        if Bundle.main.path(forResource: "GoogleService-Info", ofType: "plist") != nil {
            FirebaseApp.configure()
        } else {
            print("[TheGoodGuestApp] GoogleService-Info.plist not found — Firebase auth disabled. Add the plist for production builds.")
        }
        #if DEBUG
    ...
    private var liveRoot: some View {
        RootFlowView()
            ...
            .onOpenURL { url in
                ...
                // reversed-client-ID scheme in TheGoodGuest-Info.plist).
