...
enum DeviceIdentity {
    ...
    private static let logger = Logger(subsystem: "com.thegoodguest.TheGoodGuest", category: "DeviceIdentity")

    private static let service =
        (Bundle.main.bundleIdentifier ?? "com.thegoodguest.TheGoodGuest") + ".device-identity"
