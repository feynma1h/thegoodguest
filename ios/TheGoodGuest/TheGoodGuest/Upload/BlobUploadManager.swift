...
actor BlobUploadManager {
    ...
    private let logger = Logger(subsystem: "com.thegoodguest.TheGoodGuest", category: "BlobUpload")
    ...
    ///
    /// Called at launch via a .task modifier in TheGoodGuestApp. Loads all persisted
