...
/// (b1f63ae) and the phantom room from a migrated record (decision 0074) — and a
...
final class LiveActivityController {
    ...
    private let logger = Logger(subsystem: "com.thegoodguest.TheGoodGuest", category: "LiveActivity")
